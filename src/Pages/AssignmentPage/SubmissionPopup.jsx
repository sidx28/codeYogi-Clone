...
function SubmissionPopup(props) {
    ...
    return (
        <>
            <div onClick={props.hideSubmitFormPopup} className='fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75 '></div>
                ...
                <form className='bg-white p-4 rounded-lg '>
                    <div className='mt-5 border-t border-gray-200 sm:divide-y sm:divide-gray-200'>
                        ...
                        <div className='pt-5 mt-5'>
                            <Button onClick={onSubmitButtonClick} theme='secondary' padding='large'>Submit</Button>
                        </div>
                    </div>
                </form>
            </div>
